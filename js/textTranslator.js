let arrLang = {
    cz: {
        ...
        'clickOnSceneObjectsInfo': 'Model je rozšířen o možnost klikání na jednotlivé planety, měsíce nebo jejich orbity. Kliknutím na vesmírný objekt nebo jeho orbitu se v levé části obrazovky zobrazí tabulka s vybranými fyzikálními vlastnostmi a údaji o zvoleném tělese. Pro odlišení je vybraný objekt i jeho orbita barevně zabarvený. Údaje v tabulce jsou dostupné pouze pro čtení, tabulka je doplněna o info bubliny pro vysvětlení vybraných fyzikálních vlastností, které reagují na umístění kurzoru nad nimi. Zavření tabulky je možné pomocí kliknutí na libovolné místo v tabulce.',
        ...
        'sidebarMoonObjectsInfo': 'V nabídce jsou možnosti zobrazení všech měsíců, skrytí všech měsíců nebo zobrazení měsíců pro zvolenou planetu. Zobrazení jmen a orbit měsíců závisí od ostatních voleb v postranním panelu. Volbu je třeba potvrdit tlačítkem "Potvrdit".',
        ...
        // Planet pages - physical characteristics
        'planetInfoPhysicalValues': 'Fyzikální hodnoty planety',
        'planetInfoDiameter': 'Průměr:',
        'planetInfoMass': 'Hmotnost:',
        'planetInfoVolume': 'Objem:',
        'planetInfoSurfaceArea': 'Plocha povrchu:',
        'planetInfoGravitation': 'Gravitace:',
        'planetInfoTemperature': 'Teplota (min. a max.):',
        'planetInfoEscapeVelocity': 'Úniková rychlost:',
        'planetInfoOrbitalPeriodDays': 'Pohyb po orbitě (dni):',
        'planetInfoOrbitalSpeed': 'Rychlost pohybu po orbitě:',
        'planetInfoRotationPeriodAroundAxisHours': 'Rotace kolem vlastní osy (hod):',
        'planetInfoTitAngle': 'Úhel naklonění:',
        'planetInfoLengthOfDay': 'Délka dne (hod):',
        'planetInfoDistanceFromSun': 'Vzdálenost od Slunce:',
        'planetInfoAtmosphereComposition': 'Složení atmosfery:',
        'planetInfoSurfaceComposition': 'Složení povrchu:',
        'planetInfoRings': 'Prstence:',
        'planetInfoMoons': 'Měsíce:',
        'planetInfoGlobalMagneticField': 'Globální magnetické pole:',
        'planetInfoTypeOfPlanet': 'Typ planety:',
        'planetInfoGassGiant': 'Plynný obr',
        'planetInfoIceGiant': 'Ledový obr',
        'planetInfoAstronomicalSymbol': 'Astronomický symbol:',
        'planetInfoWeightOfHuman': 'Hmotnost člověka (ve srovnání se Zemí):',
        'planetInfoDiscoveryYear': 'Rok objevení:',
        'planetInfoNumberOfLandings': 'Počet přistání:',
        'planetInfoFirstLanding': 'První přistání (rok):',
        'yesAnswer': 'Ano',
        'noAnswer': 'Ne',
    },
    en: {
        ...
        'sidebarMoonObjectsInfo': 'In the sidebar there are options to show all moons, hide all moons or show moons for the selected planet. The display of names and orbits of the moons depends on the other chosen options in the sidebar. The selection must be confirmed with the "Confirm" button.',
        ...
        // Planet pages - physical characteristics
        'planetInfoPhysicalValues': 'Physical values of planet',
        'planetInfoDiameter': 'Diameter:',
        'planetInfoMass': 'Mass:',
        'planetInfoVolume': 'Volume:',
        'planetInfoSurfaceArea': 'Surface area:',
        'planetInfoGravitation': 'Gravitation:',
        'planetInfoTemperature': 'Temperature (min. and max.):',
        'planetInfoEscapeVelocity': 'Escape velocity:',
        'planetInfoOrbitalPeriodDays': 'Orbital period (days):',
        'planetInfoOrbitalSpeed': 'Orbtital speed:',
        'planetInfoRotationPeriodAroundAxisHours': 'Rotation period around its axis (hours):',
        'planetInfoTitAngle': 'Tilt angle:',
        'planetInfoLengthOfDay': 'Length of the day (hours):',
        'planetInfoDistanceFromSun': 'Distance from the Sun:',
        'planetInfoAtmosphereComposition': 'Atmosphere composition:',
        'planetInfoSurfaceComposition': 'Surface composition:',
        'planetInfoRings': 'Rings:',
        'planetInfoMoons': 'Moons:',
        'planetInfoGlobalMagneticField': 'Global magnetic field:',
        'planetInfoTypeOfPlanet': 'Type of planet:',
        'planetInfoGassGiant': 'Gass giant',
        'planetInfoIceGiant': 'Ice giant',
        'planetInfoAstronomicalSymbol': 'Astronomical symbol:',
        'planetInfoWeightOfHuman': 'Weight of human (compared with Earth):',
        'planetInfoDiscoveryYear': 'Discovery year:',
        'planetInfoNumberOfLandings': 'Number of landings:',
        'planetInfoFirstLanding': 'First landing (year):',
        'yesAnswer': 'Yes',
        'noAnswer': 'No'
    },
    sk: {
        ...
        'clickOnSceneObjectsInfo': 'Model je rozšírený o možnosť klikania na jednotlivé planéty, mesiace alebo ich orbity. Kliknutím na vesmírny objekt alebo jeho orbitu sa v ľavej časti obrazovky zobrazí tabuľka s vybranými fyzikálnymi vlastnosťami a údajmi o zvolenom telese. Pre odlíšenie sú vybraný objekt aj jeho orbita farebne zvýraznené. Údaje v tabuľke sú dostupné len na čítanie, tabuľka je doplnená o info bubliny pre vysvetlenie vybraných fyzikálnych vlastností, ktoré reagujú na umiestnenie kurzora nad nimi. Zatvorenie tabuľky je možné pomocou kliknutia na ľubovoľné miesto v tabuľke.',
        ...
        'sidebarMoonObjectsInfo': 'V ponuke sú možnosti zobrazenia všetkých mesiacov, skrytie všetkých mesiacov alebo zobrazenie mesiacov pre zvolenú planétu. Zobrazenie mien a orbít mesiacov závisí od ostatných volieb v bočnom paneli. Voľbu je potrebné potvrdiť tlačidlom "Potvrdiť".',
        ...
        // Planet pages - physical characteristics
        'planetInfoPhysicalValues': 'Fyzikálne hodnoty planéty',
        'planetInfoDiameter': 'Priemer:',
        'planetInfoMass': 'Hmotnosť:',
        'planetInfoVolume': 'Objem:',
        'planetInfoSurfaceArea': 'Plocha povrchu:',
        'planetInfoGravitation': 'Gravitácia:',
        'planetInfoTemperature': 'Teplota (min. a max.):',
        'planetInfoEscapeVelocity': 'Úniková rýchlosť:',
        'planetInfoOrbitalPeriodDays': 'Pohyb po orbite (dni):',
        'planetInfoOrbitalSpeed': 'Rýchlosť pohybu po orbite:',
        'planetInfoRotationPeriodAroundAxisHours': 'Rotácia okolo vlastnej osi (hod):',
        'planetInfoTitAngle': 'Uhol naklonenia:',
        'planetInfoLengthOfDay': 'Dĺžka dňa (hod):',
        'planetInfoDistanceFromSun': 'Vzdialenosť od Slnka:',
        'planetInfoAtmosphereComposition': 'Zloženie atmosféry:',
        'planetInfoSurfaceComposition': 'Zloženie povrchu:',
        'planetInfoRings': 'Prstence:',
        'planetInfoMoons': 'Mesiace:',
        'planetInfoGlobalMagneticField': 'Globálne magnetické pole:',
        'planetInfoTypeOfPlanet': 'Typ planéty:',
        'planetInfoGassGiant': 'Plynný obor',
        'planetInfoIceGiant': 'Ľadový obor',
        'planetInfoAstronomicalSymbol': 'Astronomický symbol:',
        'planetInfoWeightOfHuman': 'Hmotnosť človeka (v porovnaní so Zemou):',
        'planetInfoDiscoveryYear': 'Rok objavenia:',
        'planetInfoNumberOfLandings': 'Počet pristátí:',
        'planetInfoFirstLanding': 'Prvé pristátie (rok):',
        'yesAnswer': 'Áno',
        'noAnswer': 'Nie'
    }
}
